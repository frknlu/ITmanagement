...
<form action="others.php?process=new" method="post">
...
<form action="others.php?process=update" method="post">
		 <div class="modal fade" id="edit_modal" tabindex="-1" aria-labelledby="editmodaltitle" aria-hidden="true">
		  ...
		  <form action="others.php?process=delete" method="post">
...
echo '<meta http-equiv="refresh" content="0;URL=others.php?id='.$process_id.'">';
}
break;
case "update":
$id = $_POST["id"];
...
<script>
        $(document).ready(function(){
            var dataTable = $('#empTable').DataTable({
			  ...
			  '</a> <a type="button" id="'+ data +'" class="item-edit edit_modal" title="Edit">'+ feather.icons['edit'].toSvg({ class: 'me-50' }) +'</a>' + '<a target="_blank" href="print/others.php?id='+ data +'" class="item-edit" title="Print">'+ feather.icons['printer'].toSvg({ class: 'me-50' }) +'</a>' :
                data;
				}}
				],
