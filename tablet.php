...
$last_query = sqlsrv_query($con,"INSERT INTO inventory (users,number,type,short_number,sim,brand,model,color,sn,imeil,hdd,nots,data_type) values ('".$users."','".$number."','".$type."','".$short_number."','".$sim."','".$brand."','".$model."','".$color."','".$sn."','".$imeil."','".$hdd."','".$nots."','3')") or die( print_r( sqlsrv_errors(), true));
