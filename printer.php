...
<head>
    ...
    <title>Diğer Cihazlar | Danet IT</title>
...
<form action="printer.php?process=new" method="post">
								...
								<div class="row">
									...
									<div class="col-md-6">
									  ...
									  <div class="col-md-6">
											...
											<label class="form-label" for="Toner_q">Toner Adedi</label>
											<input type="text" id="Toner_q" class="form-control" name="toner_q" placeholder="Toner Adedi"/>											
...
<form action="printer.php?process=update" method="post">
		 <div class="modal fade" id="edit_modal" tabindex="-1" aria-labelledby="editmodaltitle" aria-hidden="true">
		  ...
		  <form action="printer.php?process=delete" method="post">
...
echo '<meta http-equiv="refresh" content="0;URL=printer.php?id='.$process_id.'">';
}
break;
case "update":
$id = $_POST["id"];
...
<script>
        $(document).ready(function(){
            var dataTable = $('#empTable').DataTable({
			  ...
			  '</a> <a type="button" id="'+ data +'" class="item-edit edit_modal" title="Edit">'+ feather.icons['edit'].toSvg({ class: 'me-50' }) +'</a>' + '<a target="_blank" href="print/printer.php?id='+ data +'" class="item-edit" title="Print">'+ feather.icons['printer'].toSvg({ class: 'me-50' }) +'</a>' :
                data;
				}}
				],
